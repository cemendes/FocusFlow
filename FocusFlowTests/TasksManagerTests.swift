...
class TasksManagerTests {
    ...
    func testInit() {
        setUp()
        assert(manager.userName == "User", "Initial userName should be User")
    ...
    func testJSONParsing() {
        ...
        do {
            ...
            assert(task1.resolvedProject == "Acme", "Task 1 resolved project should be 'Acme'")
